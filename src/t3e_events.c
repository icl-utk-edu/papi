...
const hwi_search_t _papi_hwd_t3e_preset_map[] = {
   ...
   {PAPI_BR_UCN, {0, {PNE_T3E_JSR_RET_FC, PAPI_NULL, PAPI_NULL}, {0,}}},
   {PAPI_BR_CN, {0, {PNE_T3E_COND_BR_FC, PAPI_NULL, PAPI_NULL}, {0,}}},
