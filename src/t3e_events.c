...
const hwi_search_t _papi_hwd_preset_map[] = {
   ...
   {PAPI_BR_UCN, {DERIVED_ADD, {PAPI_NULL, PNE_T3E_JSR_RET_FC, PNE_T3E_PC_MISPRE
DICTS}, {0,}}},
   {PAPI_BR_CN, {DERIVED_ADD, {PAPI_NULL, PNE_T3E_JSR_RET_FC, PNE_T3E_BR_MISPRED
ICTS}, {0,}}},
   {PAPI_BR_MSP, {0, {PAPI_NULL, PAPI_NULL, PNE_T3E_BR_MISPREDICTS}, {0,}}},
   {PAPI_TOT_IIS, {0, {PAPI_NULL, PNE_T3E_ICACHE, PAPI_NULL}, {0,}}},
   ...
   {PAPI_BR_INS, {0, {PAPI_NULL, PNE_T3E_JSR_RET_FC, PAPI_NULL}, {0,}}},
