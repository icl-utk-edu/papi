...
enum native_name {
	PNE_PM_0INST_CLB_CYC = 0x40000000,
	PNE_PM_0INST_FETCH,
...
typedef PWR5_register_t hwd_register_t;

typedef struct PWR5_groups {
  unsigned int mmcr0;
  unsigned int mmcr1L;
  unsigned int mmcr1U;
  unsigned int mmcra;
...
typedef PWR5_groups_t hwd_groups_t;
...
typedef struct PWR5_native_map {
   /* native event name */
   char *name;
...
extern PWR5_native_map_t native_name_map[MAX_NATNAME_MAP_INDEX];
