...
const hwi_search_t _papi_hwd_core_preset_map[] = {
	{PAPI_L1_DCM,
	 {0, {PNE_CORE_DCACHE_REPL, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_ICM,
	 {0, {PNE_CORE_L2_IFETCH_SELF_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_DCM,
	 {DERIVED_SUB,
	  {PNE_CORE_L2_LINES_IN_SELF_ANY, PNE_CORE_BUS_TRANS_IFETCH_SELF, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L2_ICM,
	 {0, {PNE_CORE_BUS_TRANS_IFETCH_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L1_TCM,
	 {0, {PNE_CORE_L2_RQSTS_SELF_DEMAND_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_TCM,
	 {0, {PNE_CORE_L2_LINES_IN_SELF_ANY, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_CA_SHR,
	 {0, {PNE_CORE_L2_RQSTS_SELF_ANY_S, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_CA_CLN,
	 {0, {PNE_CORE_BUS_TRANS_RFO_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
/*   { PAPI_CA_INV, {0, {PNE_PM_BUS_HITM_DRV,PAPI_NULL,PAPI_NULL,PAPI_NULL},{0,}}},   */
	{PAPI_CA_ITV,
	 {0, {PNE_CORE_BUS_TRANS_INVAL_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_TLB_IM,
	 {0, {PNE_CORE_ITLB_MISSES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TLB_DM,
	 {0, {PNE_CORE_DTLB_MISS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_LDM,
	 {0, {PNE_CORE_L2_LD_SELF_ANY_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L1_STM,
	 {0, {PNE_CORE_L2_ST_SELF_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_LDM,
	 {DERIVED_SUB,
	  {PNE_CORE_L2_LINES_IN_SELF_ANY, PNE_CORE_L2_M_LINES_IN_SELF, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L2_STM,
	 {0, {PNE_CORE_L2_M_LINES_IN_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BTAC_M,
	 {0, {PNE_CORE_BTB_MISSES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_HW_INT,
	 {0, {PNE_CORE_HW_INT_RX, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_CN,
	 {0, {PNE_CORE_BR_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_TKN,
	 {0, {PNE_CORE_BR_TAKEN_RET, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_NTK,
	 {DERIVED_SUB,
	  {PNE_CORE_BR_RETIRED, PNE_CORE_BR_TAKEN_RET, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_BR_MSP,
	 {0, {PNE_CORE_MISPREDBR_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_PRC,
	 {DERIVED_SUB,
	  {PNE_CORE_BR_RETIRED, PNE_CORE_MISPREDBR_RETIRED, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_TOT_IIS,
	 {0, {PNE_CORE_INSTR_DECODED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TOT_INS,
	 {0, {PNE_CORE_INSTR_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_FP_INS,
	 {0, {PNE_CORE_FP_COMPS_OP_EXE, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_FP_OPS,
	 {0, {PNE_CORE_FP_COMPS_OP_EXE, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_INS,
	 {0, {PNE_CORE_BR_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
/*   { PAPI_VEC_INS,       {0, {PNE_PM_MMX_INSTR_EXEC,PAPI_NULL,PAPI_NULL,PAPI_NULL},{0,}}},  Says event exists on P2 only  */
	{PAPI_RES_STL,
	 {0, {PNE_CORE_RESOURCE_STALL, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TOT_CYC,
	 {0, {PNE_CORE_UNHLTCORE_CYCLES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_DCH,
	 {DERIVED_SUB,
	  {PNE_CORE_DATA_MEM_REF, PNE_CORE_DCACHE_REPL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L1_DCA,
	 {0, {PNE_CORE_DATA_MEM_REF, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_DCA,
	 {DERIVED_ADD,
	  {PNE_CORE_L2_LD_SELF_ANY_MESI, PNE_CORE_L2_ST_SELF_MESI, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L2_DCR,
	 {0, {PNE_CORE_L2_LD_SELF_ANY_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	...
	{PAPI_L1_ICH,
	 {DERIVED_SUB,
	  {PNE_CORE_BUS_TRANS_IFETCH_SELF, PNE_CORE_L2_IFETCH_SELF_MESI, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L2_ICH,
	 {DERIVED_SUB,
	  {PNE_CORE_L2_IFETCH_SELF_MESI, PNE_CORE_BUS_TRANS_IFETCH_SELF, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L1_ICA,
	 {0, {PNE_CORE_BUS_TRANS_IFETCH_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	...
	{PAPI_L2_TCH,
	 {DERIVED_SUB,
	  {PNE_CORE_L2_RQSTS_SELF_ANY_MESI, PNE_CORE_L2_LINES_IN_SELF_ANY,
	   PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_TCA,
	 {DERIVED_ADD,
	  {PNE_CORE_DATA_MEM_REF, PNE_CORE_BUS_TRANS_IFETCH_SELF, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L2_TCA,
	 {0, {PNE_CORE_L2_RQSTS_SELF_ANY_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_TCR,
	 {DERIVED_ADD,
	  {PNE_CORE_L2_LD_SELF_ANY_MESI, PNE_CORE_L2_IFETCH_SELF_MESI, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L2_TCW,
	 {0, {PNE_CORE_L2_ST_SELF_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
...
const int _papi_hwd_core_native_count =
	( PNE_CORE_LAST_NATIVE_EVENT & PAPI_NATIVE_AND_MASK );
