...
#define IOCTL_PMC_WRITE_CONTROL_REGS \
    CTL_CODE(PMC_TYPE, 0x932, METHOD_BUFFERED, FILE_WRITE_ACCESS)

#define IOCTL_PMC_WRITE_DATA_REGS \
    CTL_CODE(PMC_TYPE, 0x933, METHOD_BUFFERED, FILE_WRITE_ACCESS)

#define  IOCTL_PMC_READ_DATA_REGS \
    CTL_CODE(PMC_TYPE, 0x934, METHOD_BUFFERED, FILE_WRITE_ACCESS)
