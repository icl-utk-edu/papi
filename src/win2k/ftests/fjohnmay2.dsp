# Microsoft Developer Studio Project File - Name="fjohnmay2" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=fjohnmay2 - Win32 Release
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "fjohnmay2.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "fjohnmay2.mak" CFG="fjohnmay2 - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "fjohnmay2 - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "fjohnmay2 - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "fjohnmay2 - Win32 Release"
...
!ELSEIF  "$(CFG)" == "fjohnmay2 - Win32 Debug"
...
# Name "fjohnmay2 - Win32 Release"
# Name "fjohnmay2 - Win32 Debug"
