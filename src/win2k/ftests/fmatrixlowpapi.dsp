# Microsoft Developer Studio Project File - Name="fmatrixlowpapi" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=fmatrixlowpapi - Win32 Release
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "fmatrixlowpapi.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "fmatrixlowpapi.mak" CFG="fmatrixlowpapi - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "fmatrixlowpapi - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "fmatrixlowpapi - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "fmatrixlowpapi - Win32 Release"
...
!ELSEIF  "$(CFG)" == "fmatrixlowpapi - Win32 Debug"
...
# Name "fmatrixlowpapi - Win32 Release"
# Name "fmatrixlowpapi - Win32 Debug"
...
SOURCE=..\..\ftests\fmatrixlowpapi.F
# End Source File
# Begin Source File
