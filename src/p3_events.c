...
hwi_search_t _papi_hwd_p3_preset_map[] = {
   {PAPI_L1_DCM,{0,{PNE_P3_DCU_LINES_IN,PAPI_NULL},{0,}}},
   {PAPI_L1_ICM,{0,{PNE_P3_L2_IFETCH_MESI,PAPI_NULL},{0,}}},
   {PAPI_L2_DCM,{DERIVED_SUB,{PNE_P3_L2_LINES_IN,PNE_P3_BUS_TRAN_IFETCH_SELF,PAPI_NULL},{0,}}},
   {PAPI_L2_ICM, {0, {PNE_P3_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCM, {0, {PNE_P3_L2_RQSTS_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCM, {0, {PNE_P3_L2_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_CA_SHR, {0, {PNE_P3_L2_RQSTS_S, PAPI_NULL}, {0,}}},
   {PAPI_CA_CLN, {0, {PNE_P3_BUS_TRAN_RFO_SELF, PAPI_NULL}, {0,}}},
/*   { PAPI_CA_INV, {0, {PNE_P3_BUS_HITM_DRV,PAPI_NULL},{0,}}},   */
   {PAPI_CA_ITV, {0, {PNE_P3_BUS_TRAN_INVAL_SELF, PAPI_NULL}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_P3_ITLB_MISS, PAPI_NULL}, {0,}}},
   {PAPI_L1_LDM, {0, {PNE_P3_L2_LD_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_STM, {0, {PNE_P3_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_LDM, {DERIVED_SUB, {PNE_P3_L2_LINES_IN, PNE_P3_L2_M_LINES_INM, PAPI_NULL}, {0,}}},
   {PAPI_L2_STM, {0, {PNE_P3_L2_M_LINES_INM, PAPI_NULL}, {0,}}},
   {PAPI_BTAC_M, {0, {PNE_P3_BTB_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_HW_INT, {0, {PNE_P3_HW_INT_RX, PAPI_NULL}, {0,}}},
   {PAPI_BR_CN, {0, {PNE_P3_BR_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_TKN, {0, {PNE_P3_BR_TAKEN_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_NTK,
    {DERIVED_SUB, {PNE_P3_BR_INST_RETIRED, PNE_P3_BR_TAKEN_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_P3_BR_MISS_PRED_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_PRC,
    {DERIVED_SUB, {PNE_P3_BR_INST_RETIRED, PNE_P3_BR_MISS_PRED_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_TOT_IIS, {0, {PNE_P3_INST_DECODED, PAPI_NULL}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_P3_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_FP_INS, {0, {PNE_P3_FLOPS, PAPI_NULL}, {0,}}},
   {PAPI_FP_OPS, {0, {PNE_P3_FLOPS, PAPI_NULL}, {0,}}},
   {PAPI_BR_INS, {0, {PNE_P3_BR_INST_RETIRED, PAPI_NULL}, {0,}}},
/*   { PAPI_VEC_INS,       {0, {PNE_P3_MMX_INSTR_EXEC,PAPI_NULL},{0,}}},  Says event exists on P2 only  */
   {PAPI_RES_STL, {0, {PNE_P3_RESOURCE_STALLS, PAPI_NULL}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_P3_CPU_CLK_UNHALTED, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCH, {DERIVED_SUB, {PNE_P3_DATA_MEM_REFS, PNE_P3_DCU_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCA, {0, {PNE_P3_DATA_MEM_REFS, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCA, {DERIVED_ADD, {PNE_P3_L2_LD_MESI, PNE_P3_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCR, {0, {PNE_P3_L2_LD_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCW, {0, {PNE_P3_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICH, {DERIVED_SUB, {PNE_P3_IFU_IFETCH, PNE_P3_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICH,
    {DERIVED_SUB, {PNE_P3_L2_IFETCH_MESI, PNE_P3_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICA, {0, {PNE_P3_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICA, {0, {PNE_P3_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICR, {0, {PNE_P3_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICR, {0, {PNE_P3_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCH, {DERIVED_SUB, {PNE_P3_L2_RQSTS_MESI, PNE_P3_L2_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCA, {DERIVED_ADD, {PNE_P3_DATA_MEM_REFS, PNE_P3_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCA, {0, {PNE_P3_L2_RQSTS_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCR, {DERIVED_ADD, {PNE_P3_L2_LD_MESI, PNE_P3_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCW, {0, {PNE_P3_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_FML_INS, {0, {PNE_P3_MUL, PAPI_NULL}, {0,}}},
   {PAPI_FDV_INS, {0, {PNE_P3_DIV, PAPI_NULL}, {0,}}},
   {0, {0, {PAPI_NULL}, {0,}}}
};

hwi_search_t _papi_hwd_pm_preset_map[] = {
   {PAPI_L1_DCM,{0,{PNE_PM_DCU_LINES_IN,PAPI_NULL},{0,}}},
   {PAPI_L1_ICM,{0,{PNE_PM_L2_IFETCH_MESI,PAPI_NULL},{0,}}},
   {PAPI_L2_DCM,{DERIVED_SUB,{PNE_PM_L2_TOT_LINES_IN,PNE_PM_BUS_TRAN_IFETCH_SELF,PAPI_NULL},{0,}}},
   {PAPI_L2_ICM, {0, {PNE_PM_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCM, {0, {PNE_PM_L2_RQSTS_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCM, {0, {PNE_PM_L2_TOT_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_CA_SHR, {0, {PNE_PM_L2_RQSTS_S, PAPI_NULL}, {0,}}},
   {PAPI_CA_CLN, {0, {PNE_PM_BUS_TRAN_RFO_SELF, PAPI_NULL}, {0,}}},
/*   { PAPI_CA_INV, {0, {PNE_PM_BUS_HITM_DRV,PAPI_NULL},{0,}}},   */
   {PAPI_CA_ITV, {0, {PNE_PM_BUS_TRAN_INVAL_SELF, PAPI_NULL}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_PM_ITLB_MISS, PAPI_NULL}, {0,}}},
   {PAPI_L1_LDM, {0, {PNE_PM_L2_LD_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_STM, {0, {PNE_PM_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_LDM, {DERIVED_SUB, {PNE_PM_L2_TOT_LINES_IN, PNE_PM_L2_M_LINES_INM, PAPI_NULL}, {0,}}},
   {PAPI_L2_STM, {0, {PNE_PM_L2_M_LINES_INM, PAPI_NULL}, {0,}}},
   {PAPI_BTAC_M, {0, {PNE_PM_BTB_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_HW_INT, {0, {PNE_PM_HW_INT_RX, PAPI_NULL}, {0,}}},
   {PAPI_BR_CN, {0, {PNE_PM_BR_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_TKN, {0, {PNE_PM_BR_TAKEN_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_NTK,
    {DERIVED_SUB, {PNE_PM_BR_INST_RETIRED, PNE_PM_BR_TAKEN_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_PM_BR_MISS_PRED_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_PRC,
    {DERIVED_SUB, {PNE_PM_BR_INST_RETIRED, PNE_PM_BR_MISS_PRED_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_TOT_IIS, {0, {PNE_PM_INST_DECODED, PAPI_NULL}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_PM_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_FP_INS, {0, {PNE_PM_FLOPS, PAPI_NULL}, {0,}}},
   {PAPI_FP_OPS, {0, {PNE_PM_FLOPS, PAPI_NULL}, {0,}}},
   {PAPI_BR_INS, {0, {PNE_PM_BR_INST_RETIRED, PAPI_NULL}, {0,}}},
/*   { PAPI_VEC_INS,       {0, {PNE_PM_MMX_INSTR_EXEC,PAPI_NULL},{0,}}},  Says event exists on P2 only  */
   {PAPI_RES_STL, {0, {PNE_PM_RESOURCE_STALLS, PAPI_NULL}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_PM_CPU_CLK_UNHALTED, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCH, {DERIVED_SUB, {PNE_PM_DATA_MEM_REFS, PNE_PM_DCU_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCA, {0, {PNE_PM_DATA_MEM_REFS, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCA, {DERIVED_ADD, {PNE_PM_L2_LD_MESI, PNE_PM_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCR, {0, {PNE_PM_L2_LD_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCW, {0, {PNE_PM_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICH, {DERIVED_SUB, {PNE_PM_IFU_IFETCH, PNE_PM_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICH,
    {DERIVED_SUB, {PNE_PM_L2_IFETCH_MESI, PNE_PM_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICA, {0, {PNE_PM_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICA, {0, {PNE_PM_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICR, {0, {PNE_PM_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICR, {0, {PNE_PM_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCH, {DERIVED_SUB, {PNE_PM_L2_RQSTS_MESI, PNE_PM_L2_TOT_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCA, {DERIVED_ADD, {PNE_PM_DATA_MEM_REFS, PNE_PM_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCA, {0, {PNE_PM_L2_RQSTS_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCR, {DERIVED_ADD, {PNE_PM_L2_LD_MESI, PNE_PM_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCW, {0, {PNE_PM_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_FML_INS, {0, {PNE_PM_MUL, PAPI_NULL}, {0,}}},
   {PAPI_FDV_INS, {0, {PNE_PM_DIV, PAPI_NULL}, {0,}}},
   {0, {0, {PAPI_NULL}, {0,}}}
};

hwi_search_t _papi_hwd_p2_preset_map[] = {
   {PAPI_L1_DCM, {0, {PNE_P2_DCU_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICM, {0, {PNE_P2_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCM,
    {DERIVED_SUB, {PNE_P2_L2_LINES_IN, PNE_P2_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICM, {0, {PNE_P2_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCM, {0, {PNE_P2_L2_RQSTS_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCM, {0, {PNE_P2_L2_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_CA_SHR, {0, {PNE_P2_L2_RQSTS_S, PAPI_NULL}, {0,}}},
   {PAPI_CA_CLN, {0, {PNE_P2_BUS_TRAN_RFO_SELF, PAPI_NULL}, {0,}}},
/*   { PAPI_CA_INV,        {0, { PNE_P2_BUS_HITM_DRV,PAPI_NULL},{0,}}},   */
   {PAPI_CA_ITV, {0, {PNE_P2_BUS_TRAN_INVAL_SELF, PAPI_NULL}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_P2_ITLB_MISS, PAPI_NULL}, {0,}}},
   {PAPI_L1_LDM, {0, {PNE_P2_L2_LD_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_STM, {0, {PNE_P2_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_LDM, {DERIVED_SUB, {PNE_P2_L2_LINES_IN, PNE_P2_L2_M_LINES_INM, PAPI_NULL}, {0,}}},
   {PAPI_L2_STM, {0, {PNE_P2_L2_M_LINES_INM, PAPI_NULL}, {0,}}},
   {PAPI_BTAC_M, {0, {PNE_P2_BTB_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_HW_INT, {0, {PNE_P2_HW_INT_RX, PAPI_NULL}, {0,}}},
   {PAPI_BR_CN, {0, {PNE_P2_BR_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_TKN, {0, {PNE_P2_BR_TAKEN_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_NTK,
    {DERIVED_SUB, {PNE_P2_BR_INST_RETIRED, PNE_P2_BR_TAKEN_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_P2_BR_MISS_PRED_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_BR_PRC,
    {DERIVED_SUB, {PNE_P2_BR_INST_RETIRED, PNE_P2_BR_MISS_PRED_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_TOT_IIS, {0, {PNE_P2_INST_DECODED, PAPI_NULL}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_P2_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_FP_INS, {0, {PNE_P2_FLOPS, PAPI_NULL}, {0,}}},
   {PAPI_FP_OPS, {0, {PNE_P2_FLOPS, PAPI_NULL}, {0,}}},
   {PAPI_BR_INS, {0, {PNE_P2_BR_INST_RETIRED, PAPI_NULL}, {0,}}},
   {PAPI_VEC_INS, {0, {PNE_P2_MMX_INSTR_EXEC, PAPI_NULL}, {0,}}},
   {PAPI_RES_STL, {0, {PNE_P2_RESOURCE_STALLS, PAPI_NULL}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_P2_CPU_CLK_UNHALTED, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCH, {DERIVED_SUB, {PNE_P2_DATA_MEM_REFS, PNE_P2_DCU_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCA, {0, {PNE_P2_DATA_MEM_REFS, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCA, {DERIVED_ADD, {PNE_P2_L2_LD_MESI, PNE_P2_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCR, {0, {PNE_P2_L2_LD_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCW, {0, {PNE_P2_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICH, {DERIVED_SUB, {PNE_P2_IFU_IFETCH, PNE_P2_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICH,
    {DERIVED_SUB, {PNE_P2_L2_IFETCH_MESI, PNE_P2_BUS_TRAN_IFETCH_SELF, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICA, {0, {PNE_P2_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICA, {0, {PNE_P2_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICR, {0, {PNE_P2_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICR, {0, {PNE_P2_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCH, {DERIVED_SUB, {PNE_P2_L2_RQSTS_MESI, PNE_P2_L2_LINES_IN, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCA, {DERIVED_ADD, {PNE_P2_DATA_MEM_REFS, PNE_P2_IFU_IFETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCA, {0, {PNE_P2_L2_RQSTS_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCR, {DERIVED_ADD, {PNE_P2_L2_LD_MESI, PNE_P2_L2_IFETCH_MESI, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCW, {0, {PNE_P2_L2_ST_MESI, PAPI_NULL}, {0,}}},
   {PAPI_FML_INS, {0, {PNE_P2_MUL, PAPI_NULL}, {0,}}},
   {PAPI_FDV_INS, {0, {PNE_P2_DIV, PAPI_NULL}, {0,}}},
   {0, {0, {PAPI_NULL}, {0,}}}
};

hwi_search_t _papi_hwd_ath_preset_map[] = {
   {PAPI_L1_DCM, {DERIVED_ADD, {PNE_ATH_SYS_DC_REFILLS_MOES, PNE_ATH_L2_DC_REFILLS_MOES, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICM, {0, {PNE_ATH_IC_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCM, {0, {PNE_ATH_SYS_DC_REFILLS_MOES, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICM, {0, {PNE_ATH_SYS_IC_REFILLS, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCM, {DERIVED_ADD, {PNE_ATH_SYS_DC_REFILLS_MOES, PNE_ATH_L2_DC_REFILLS_MOES, PNE_ATH_IC_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_L2_TCM,
    {DERIVED_ADD, {PNE_ATH_SYS_DC_REFILLS_MOES, PNE_ATH_SYS_IC_REFILLS, PAPI_NULL}, {0,}}},
   {PAPI_TLB_DM, {0, {PNE_ATH_L1_AND_L2_DTLB_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_ATH_L2_ITLB_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_TLB_TL,
    {DERIVED_ADD, {PNE_ATH_L1_AND_L2_DTLB_MISSES, PNE_ATH_L2_ITLB_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_L1_LDM, {0, {PNE_ATH_L2_DC_REFILLS_OES, PAPI_NULL}, {0,}}},
   {PAPI_L1_STM, {0, {PNE_ATH_L2_DC_REFILLS_M, PAPI_NULL}, {0,}}},
   {PAPI_L2_LDM, {0, {PNE_ATH_SYS_DC_REFILLS_OES, PAPI_NULL}, {0,}}},
   {PAPI_L2_STM, {0, {PNE_ATH_SYS_DC_REFILLS_M, PAPI_NULL}, {0,}}},
   {PAPI_HW_INT, {0, {PNE_ATH_TAKEN_HARDWARE_INTS, PAPI_NULL}, {0,}}},
   {PAPI_BR_UCN, {0, {PNE_ATH_RET_FAR_CONTROL_TRANSFERS, PAPI_NULL}, {0,}}},
   {PAPI_BR_CN, {0, {PNE_ATH_RET_BR, PAPI_NULL}, {0,}}},
   {PAPI_BR_TKN, {0, {PNE_ATH_RET_TAKEN_BR, PAPI_NULL}, {0,}}},
   {PAPI_BR_NTK, {DERIVED_SUB, {PNE_ATH_RET_BR, PNE_ATH_RET_TAKEN_BR, PAPI_NULL}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_ATH_RET_BR_MIS, PAPI_NULL}, {0,}}},
   {PAPI_BR_PRC, {DERIVED_SUB, {PNE_ATH_RET_BR, PNE_ATH_RET_BR_MIS, PAPI_NULL}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_ATH_RET_INSTRUCTIONS, PAPI_NULL}, {0,}}},
   {PAPI_BR_INS, {0, {PNE_ATH_RET_TAKEN_BR, PAPI_NULL}, {0,}}},
//   { PAPI_VEC_INS,           {0, { PNE_ATH_DCU_LINES_IN,PAPI_NULL},{0,}}},
   {PAPI_RES_STL, {0, {PNE_ATH_ALL_QUIET_STALL, PAPI_NULL}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_ATH_TOT_CYC, PAPI_NULL}, {0,}}},
   ...
   {PAPI_L2_DCH, {0, {PNE_ATH_L2_DC_REFILLS_MOES, PAPI_NULL}, {0,}}},
   {PAPI_L1_DCA, {0, {PNE_ATH_DC_ACCESSES, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCA, {DERIVED_ADD, {PNE_ATH_SYS_DC_REFILLS_MOES, PNE_ATH_L2_DC_REFILLS_MOES, PAPI_NULL}, {0,}}},
   {PAPI_L2_DCR, {0, {PNE_ATH_L2_DC_REFILLS_OES, PAPI_NULL},{0,}}},
   {PAPI_L2_DCW, {0, {PNE_ATH_L2_DC_REFILLS_M, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICA, {0, {PNE_ATH_IC_FETCHES, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICA, {0, {PNE_ATH_IC_MISSES, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICR, {0, {PNE_ATH_IC_FETCHES, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCA, {DERIVED_ADD, {PNE_ATH_DC_ACCESSES, PNE_ATH_IC_FETCHES, PAPI_NULL}, {0,}}},
   {0, {0, {PAPI_NULL}, {0,}}}
};
...
hwi_search_t _papi_hwd_opt_preset_map[] = {
   ...
   {PAPI_L2_ICH, {0, {PNE_OPT_IC_L2_REFILL, PAPI_NULL}, {0,}}},
   ...
   {PAPI_FPU_IDL, {0, {PNE_OPT_FP_NONE_RET, PAPI_NULL}, {0,}}},
   {PAPI_TLB_DM, {0, {PNE_OPT_DC_L1_DTLB_MISS_AND_L2_DTLB_MISS, PAPI_NULL}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_OPT_IC_L1ITLB_MISS_AND_L2ITLB_MISS, PAPI_NULL}, {0,}}},
   {PAPI_TLB_TL, {DERIVED_ADD, {PNE_OPT_DC_L1_DTLB_MISS_AND_L2_DTLB_MISS, PNE_OPT_IC_L1ITLB_MISS_AND_L2ITLB_MISS, PAPI_NULL},{0,}}},
   ...
   {PAPI_STL_ICY,{0, {PNE_OPT_FR_DECODER_EMPTY, PAPI_NULL}, {0,}}},
   {PAPI_HW_INT, {0, {PNE_OPT_FR_HW_INTS, PAPI_NULL}, {0,}}},
   {PAPI_BR_TKN, {0, {PNE_OPT_FR_BR_TAKEN, PAPI_NULL}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_OPT_FR_BR_MIS, PAPI_NULL}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_OPT_FR_X86_INS, PAPI_NULL}, {0,}}},
   {PAPI_FP_INS, {0, {PNE_OPT_FP_MULT_AND_ADD_PIPE, PAPI_NULL}, {0,}}},
   {PAPI_FP_OPS, {0, {PNE_OPT_FP_MULT_AND_ADD_PIPE, PAPI_NULL}, {0,}}},
   {PAPI_BR_INS, {0, {PNE_OPT_FR_BR, PAPI_NULL}, {0,}}},
   {PAPI_VEC_INS, {0, {PNE_OPT_FR_FPU_SSE_SSE2_PACKED, PAPI_NULL}, {0,}}},
   {PAPI_RES_STL, {0, {PNE_OPT_FR_DISPATCH_STALLS, PAPI_NULL}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_OPT_CPU_CLK_UNHALTED, PAPI_NULL}, {0,}}},
   ...
   {PAPI_L1_DCA, {0, {PNE_OPT_DC_ACCESS, PAPI_NULL}, {0,}}},
   ...
   {PAPI_L1_ICA, {0, {PNE_OPT_IC_FETCH, PAPI_NULL}, {0,}}},
   {PAPI_L2_ICA, {DERIVED_ADD, {PNE_OPT_IC_L2_REFILL, PNE_OPT_IC_SYS_REFILL, PAPI_NULL}, {0,}}},
   {PAPI_L1_ICR, {0, {PNE_OPT_IC_FETCH, PAPI_NULL}, {0,}}},
   {PAPI_L1_TCA, {DERIVED_ADD, {PNE_OPT_DC_ACCESS, PNE_OPT_IC_FETCH, PAPI_NULL}, {0,}}},
   ...
   {PAPI_FML_INS, {0, {PNE_OPT_FP_MULT_PIPE, PAPI_NULL}, {0,}}},
   {PAPI_FAD_INS, {0, {PNE_OPT_FP_ADD_PIPE, PAPI_NULL}, {0,}}},
