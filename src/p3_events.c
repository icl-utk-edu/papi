...
const hwi_search_t _papi_hwd_p3_preset_map[] = {
   ...
   {PAPI_L2_DCM,
    {DERIVED_SUB, {PNE_P3_L2_LINES_IN, PNE_P3_BUS_TRAN_IFETCH_SELF, 0, 0}, {0,}}},
...
/*   { PAPI_CA_INV,        {0, {PNE_P3_BUS_HITM_DRV,0,0,0},{0,}}},   */
   ...
   {PAPI_BR_NTK,
    {DERIVED_SUB, {PNE_P3_BR_INST_RETIRED, PNE_P3_BR_TAKEN_RETIRED, 0, 0}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_P3_BR_MISS_PRED_RETIRED, 0, 0, 0}, {0,}}},
   {PAPI_BR_PRC,
    {DERIVED_SUB, {PNE_P3_BR_INST_RETIRED, PNE_P3_BR_MISS_PRED_RETIRED, 0, 0}, {0,}}},
...
/*   { PAPI_VEC_INS,       {0, {PNE_P3_MMX_INSTR_EXEC,0,0,0},{0,}}},  Says event exists on P2 only  */
   ...
   {PAPI_L2_ICH,
    {DERIVED_SUB, {PNE_P3_L2_IFETCH_TOT, PNE_P3_BUS_TRAN_IFETCH_SELF, 0, 0}, {0,}}},
...
const hwi_search_t _papi_hwd_p2_preset_map[] = {
   ...
   {PAPI_L2_DCM,
    {DERIVED_SUB, {PNE_P2_L2_LINES_IN, PNE_P2_BUS_TRAN_IFETCH_SELF, 0, 0}, {0,}}},
...
/*   { PAPI_CA_INV,        {0, { PNE_P2_BUS_HITM_DRV,0,0,0},{0,}}},   */
   ...
   {PAPI_BR_NTK,
    {DERIVED_SUB, {PNE_P2_BR_INST_RETIRED, PNE_P2_BR_TAKEN_RETIRED, 0, 0}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_P2_BR_MISS_PRED_RETIRED, 0, 0, 0}, {0,}}},
   {PAPI_BR_PRC,
    {DERIVED_SUB, {PNE_P2_BR_INST_RETIRED, PNE_P2_BR_MISS_PRED_RETIRED, 0, 0}, {0,}}},
   ...
   {PAPI_L2_ICH,
    {DERIVED_SUB, {PNE_P2_L2_IFETCH_TOT, PNE_P2_BUS_TRAN_IFETCH_SELF, 0, 0}, {0,}}},
...
const hwi_search_t _papi_hwd_ath_preset_map[] = {
   ...
   {PAPI_L2_TCM,
    {DERIVED_ADD, {PNE_ATH_SYS_DC_REFILLS_TOT, PNE_ATH_SYS_IC_REFILLS, 0, 0}, {0,}}},
   {PAPI_TLB_DM, {0, {PNE_ATH_L1_AND_L2_DTLB_MISSES, 0, 0, 0}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_ATH_L2_ITLB_MISSES, 0, 0, 0}, {0,}}},
   {PAPI_TLB_TL,
    {DERIVED_ADD, {PNE_ATH_L1_AND_L2_DTLB_MISSES, PNE_ATH_L2_ITLB_MISSES, 0, 0}, {0,}}},
...
//   { PAPI_VEC_INS,           {0, { PNE_ATH_DCU_LINES_IN,0,0,0},{0,}}},
   ...
   {PAPI_L2_DCH,
    {DERIVED_SUB, {PNE_ATH_DC_MISSES, PNE_ATH_SYS_DC_REFILLS_TOT, 0, 0}, {0,}}},
   {PAPI_L1_DCA, {0, {PNE_ATH_DC_ACCESSES, 0, 0, 0}, {0,}}},
   {PAPI_L2_DCA, {0, {PNE_ATH_DC_MISSES, 0, 0, 0}, {0,}}},
   {PAPI_L2_DCR,
    {DERIVED_ADD,
     {PNE_ATH_L2_DC_REFILLS_OWN, PNE_ATH_L2_DC_REFILLS_EXC, PNE_ATH_L2_DC_REFILLS_SHR, 0},
     {0,}}},
   {PAPI_L2_DCW,
    {DERIVED_ADD, {PNE_ATH_L2_DC_REFILLS_MOD, PNE_ATH_L2_DC_REFILLS_INV, 0, 0}, {0,}}},
