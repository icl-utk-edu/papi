...
#ifndef _PFM4_PERF_EVENTS_H
#define _PFM4_PERF_EVENTS_H
/*
* File:    pfm4_perf_events.h
* CVS:     $Idl.h$
* Author:  Dan Terpstra
*          terpstra@eecs.utk.edu
*          - based on perf_events.h by -
*..........Corey Ashford
*          cjashfor@us.ibm.com
*
*/
...
/* These were defined by perfmon as 512.
	for now, set them to something to get past the compile error */
#define PFMLIB_MAX_PMDS		64
#define PFMLIB_MAX_PMCS		64
...
// substitute definition from perfmon
//typedef pfmlib_event_t pfm_register_t;
typedef long long pfm_register_t;

typedef int reg_alloc_t;

#define MY_VECTOR _pfm4_vector
