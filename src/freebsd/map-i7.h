...
enum NativeEvent_Value_i7Processor {
	...
	PNE_I7_LONGEST_LAT_CACHE_REFERENCE,
	PNE_I7_LONGEST_LAT_CACHE_MISS,
	...
	PNE_I7_MEM_LOAD_RETIRED_LLC_MISS,
	PNE_I7_MEM_LOAD_RETIRED_LLC_UNSHARED_HIT,
