...
hwi_search_t P6Processor_map[] = {
	{PAPI_L1_DCM, {0, {PNE_P6_DCU_LINES_IN}, {0,}}},
	{PAPI_L1_ICM, {0, {PNE_P6_L2_IFETCH}, {0,}}}, /* PNE_P6_L2_IFETCH defaults to MESI */
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_L2_DCM, {DERIVED_SUB, {PNE_P6_L2_LINES_IN, PNE_P6_BUS_TRAN_IFETCH}, {0,}}}, /* PNE_P6_BUS_TRAN_IFETCH defaults to SELF */
#endif
	{PAPI_L2_ICM, {0, {PNE_P6_BUS_TRAN_IFETCH}, {0,}}}, /* PNE_P6_BUS_TRAN_IFETCH defaults to SELF */
	{PAPI_L1_TCM, {0, {PNE_P6_L2_RQSTS}, {0,}}},
	{PAPI_L2_TCM, {0, {PNE_P6_L2_LINES_IN}, {0,}}},
	{PAPI_CA_CLN, {0, {PNE_P6_BUS_TRAN_RFO}, {0,}}},
	{PAPI_CA_ITV, {0, {PNE_P6_BUS_TRAN_INVAL}, {0,}}},
	{PAPI_TLB_IM, {0, {PNE_P6_ITLB_MISS}, {0,}}},
	{PAPI_L1_LDM, {0, {PNE_P6_L2_LD}, {0,}}},
	{PAPI_L1_STM, {0, {PNE_P6_L2_ST}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_L2_LDM, {DERIVED_SUB, {PNE_P6_L2_LINES_IN, PNE_P6_L2M_LINES_INM}, {0,}}},
#endif
	{PAPI_L2_STM, {0, {PNE_P6_L2M_LINES_INM}, {0,}}},
	{PAPI_BTAC_M, {0, {PNE_P6_BTB_MISSES}, {0,}}},
	{PAPI_HW_INT, {0, {PNE_P6_HW_INT_RX}, {0,}}},
	{PAPI_BR_CN, {0, {PNE_P6_BR_INST_RETIRED}, {0,}}},
	{PAPI_BR_TKN, {0, {PNE_P6_BR_TAKEN_RETIRED}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_BR_NTK, {DERIVED_SUB, {PNE_P6_BR_INST_RETIRED, PNE_P6_BR_TAKEN_RETIRED}, {0,}}},
#endif
	{PAPI_BR_MSP, {0, {PNE_P6_BR_MISS_PRED_RETIRED}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_BR_PRC, {DERIVED_SUB, {PNE_P6_BR_INST_RETIRED, PNE_P6_BR_MISS_PRED_RETIRED}, {0,}}},
#endif
	{PAPI_TOT_IIS, {0, {PNE_P6_INST_DECODED}, {0,}}},
	{PAPI_TOT_INS, {0, {PNE_P6_INST_RETIRED}, {0,}}},
	{PAPI_FP_INS, {0, {PNE_P6_FLOPS}, {0,}}},
	{PAPI_BR_INS, {0, {PNE_P6_BR_INST_RETIRED}, {0,}}},
	{PAPI_RES_STL, {0, {PNE_P6_RESOURCE_STALL}, {0,}}},
	{PAPI_TOT_CYC, {0, {PNE_P6_CPU_CLK_UNHALTED}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_LST_INS, {DERIVED_ADD, {PNE_P6_L2_LD,PNE_P6_L2_ST}, {0,}}},
	{PAPI_L1_DCH, {DERIVED_SUB, {PNE_P6_DATA_MEM_REFS, PNE_P6_DCU_LINES_IN}, {0,}}},
#endif
	{PAPI_L1_DCA, {0, {PNE_P6_DATA_MEM_REFS}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_L2_DCA, {DERIVED_ADD, {PNE_P6_L2_LD, PNE_P6_L2_ST}, {0,}}},
#endif
	{PAPI_L2_DCR, {0, {PNE_P6_L2_LD}, {0,}}},
	{PAPI_L2_DCW, {0, {PNE_P6_L2_ST}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_L1_ICH, {DERIVED_SUB, {PNE_P6_IFU_FETCH, PNE_P6_L2_IFETCH}, {0,}}},
	{PAPI_L2_ICH, {DERIVED_SUB, {PNE_P6_L2_IFETCH, PNE_P6_BUS_TRAN_IFETCH}, {0,}}},
#endif
	{PAPI_L1_ICA, {0, {PNE_P6_IFU_FETCH}, {0,}}},
	{PAPI_L2_ICA, {0, {PNE_P6_L2_IFETCH}, {0,}}},
	{PAPI_L1_ICR, {0, {PNE_P6_IFU_FETCH}, {0,}}},
	{PAPI_L2_ICR, {0, {PNE_P6_L2_IFETCH}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_L2_TCH, {DERIVED_SUB, {PNE_P6_L2_RQSTS, PNE_P6_L2_LINES_IN}, {0,}}},
	{PAPI_L1_TCA, {DERIVED_ADD, {PNE_P6_DATA_MEM_REFS, PNE_P6_IFU_FETCH}, {0,}}},
#endif
	{PAPI_L2_TCA, {0, {PNE_P6_L2_RQSTS}, {0,}}},
#if HWPMC_NUM_COUNTERS >= 2
	{PAPI_L2_TCR, {DERIVED_ADD, {PNE_P6_L2_LD, PNE_P6_L2_IFETCH}, {0,}}},
#endif
	{PAPI_L2_TCW, {0, {PNE_P6_L2_ST}, {0,}}},
	{PAPI_FML_INS, {0, {PNE_P6_MUL}, {0,}}},
	{PAPI_FDV_INS, {0, {PNE_P6_DIV}, {0,}}},
	{PAPI_FP_OPS, {0, {PNE_P6_FLOPS}, {0,}}},
	{0, {0, {PAPI_NULL}, {0,}}}
};
