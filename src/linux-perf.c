...
int _papi_hwd_add_event(EventSetInfo_t *ESI, int index, unsigned int EventCode)
{
...
int _papi_hwd_rem_event(EventSetInfo_t *ESI, int index, unsigned int EventCode)
{
  hwd_control_state_t *this_state = (hwd_control_state_t *)ESI->machdep;
...
int _papi_hwd_add_prog_event(EventSetInfo_t *ESI, int index, unsigned int event, void *extra)
{
  return(PAPI_ESBSTR);
}
