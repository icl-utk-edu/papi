...
#define PMU_ITA_MAX_COUNTERS	4
#define PMU_ITA_MAX_PMCS	14
#define PMU_ITA_MAX_PMDS	18
#define PMU_ITA_MAX_BTB		8
...
typedef struct {
	...
	pfmlib_ita_counter_t	pfp_ita_counters[PMU_ITA_MAX_COUNTERS];	/* extended counter features */
	...
	pfmlib_ita_ism_t 	pfp_ita_ism;		/* default instruction set */
