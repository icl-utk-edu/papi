...
#define PMU_ITA2_MAX_COUNTERS	4
#define PMU_ITA2_MAX_PMCS	16
#define PMU_ITA2_MAX_PMDS	18
#define PMU_ITA2_MAX_BTB	8
...
typedef union {
	...
	struct {
		...
		unsigned long iear_ct:2;	/* cache tlb bit */
 ...
 * 		The EAR will be programmed (PMC11 or PMC10) based on the information encoded in the
 ...
 * 		The EAR will be programmed (PMC11 or PMC12) according to the information in the 
...
typedef struct {
	unsigned long op_used:1;
	unsigned long op_opcode:41;
	unsigned long op_mask:41;
	unsigned long op_m:1;
	unsigned long op_f:1;
	unsigned long op_i:1;
	unsigned long op_b:1;
} pfmlib_ita2_opcm2_t;
...
typedef struct {
	...
	pfmlib_ita2_counter_t	pfp_ita2_counters[PMU_ITA2_MAX_COUNTERS];	/* extended counter features */
	...
	pfmlib_ita2_ism_t 	pfp_ita2_ism;		/* default instruction set */
