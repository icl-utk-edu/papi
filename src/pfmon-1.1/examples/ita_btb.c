...
static void
show_btb(pfm_ita_reg_t *btb, pfm_ita_reg_t *pmd16)
{
	int i, last;
...
main(void)
{
	 ...
	 */
	ita_param.pfp_ita_btb.btb_used = 1;

	ita_param.pfp_ita_btb.btb_tar = 0x1;
	ita_param.pfp_ita_btb.btb_tm  = 0x2;
	ita_param.pfp_ita_btb.btb_ptm = 0x3;
	ita_param.pfp_ita_btb.btb_tac = 0x1;
	ita_param.pfp_ita_btb.btb_bac = 0x1;
	ita_param.pfp_ita_btb.btb_ppm = 0x3;
	 ...
	 * event.
	 */
	if (pfm_find_event("BRANCH_EVENT",0, evt.pfp_evt) != PFMLIB_SUCCESS) {
