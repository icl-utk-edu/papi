...
Exercises EDMA-specific counters on a single Gaudi2 device using a PyTorch
workload that triggers internal memory transfers (EDMA handles HBM-to-HBM
...
Usage:
    PT_HPU_LAZY_MODE=1 python3 test_edma_events.py
"""
...
def main():
    ...
    # Step 4: Add EDMA events
    print("\n[4] Adding EDMA events...")
    events = [
    ...
    print(f"\n[5] Starting counters ({num_events} EDMA events)...")
    ...
    # Step 6: Run workload (copies and transposes to exercise EDMA)
    print("\n[6] Running EDMA workload (tensor copies/transposes, 20 iterations)...")
