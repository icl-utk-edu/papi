...
Exercises MME-specific counters on a single Gaudi2 device using a PyTorch
matrix multiplication workload which exercises the MME.
...
Usage:
    PT_HPU_LAZY_MODE=1 python3 test_mme_events.py
"""
...
def main():
    ...
    print(f"\n[5] Starting counters ({num_events} MME events)...")
    ...
    # Step 6: Run matmul workload (exercises MME heavily)
    print("\n[6] Running PyTorch matmul workload (2048x2048, 20 iterations)...")
