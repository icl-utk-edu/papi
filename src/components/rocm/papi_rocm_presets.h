...
/*  1 */ {"PAPI_ROCM_BF16_FMA",
	  "ROCM BF16 FMA instr",
	  "ROCM Half precision (BF16) FMA instructions", 0,
	  0, PAPI_PRESET_BIT_MSC,
      NULL, {0}, {NULL}, {NULL}, {0}, {NULL}, NULL, 0, 0, {NULL}, {NULL}},
/*  2 */ {"PAPI_ROCM_FP32_FMA",
	  "ROCM FP32 FMA instr",
	  "ROCM Single precision (FP32) FMA instructions", 0,
	  0, PAPI_PRESET_BIT_MSC,
      NULL, {0}, {NULL}, {NULL}, {0}, {NULL}, NULL, 0, 0, {NULL}, {NULL}},
/*  3 */ {"PAPI_ROCM_FP64_FMA",
	  "ROCM FP64 FMA instr",
	  "ROCM Double precision (FP64) FMA instructions", 0,
	  0, PAPI_PRESET_BIT_MSC,
      NULL, {0}, {NULL}, {NULL}, {0}, {NULL}, NULL, 0, 0, {NULL}, {NULL}},
/*  4 */ {"PAPI_ROCM_FP_FMA",
	  "ROCM FP FMA instr",
	  "ROCM floating-point FMA instructions", 0,
	  0, PAPI_PRESET_BIT_MSC,
      NULL, {0}, {NULL}, {NULL}, {0}, {NULL}, NULL, 0, 0, {NULL}, {NULL}},
/*  5 */ {"PAPI_ROCM_FP8_OPS",
	  "ROCM FP8 ops",
	  "ROCM 8-bit precision floating-point operations", 0,
	  0, PAPI_PRESET_BIT_MSC,
      NULL, {0}, {NULL}, {NULL}, {0}, {NULL}, NULL, 0, 0, {NULL}, {NULL}},
