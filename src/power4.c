...
static preset_search_t preset_name_map_P4[PAPI_MAX_PRESET_EVENTS] = { 
  ...
  {PAPI_L1_DCW,0,{PNE_PM_ST_REF_L1,0,0,0,0,0,0,0}}, /*Level 1 D cache write */
  {PAPI_L1_DCR,0,{PNE_PM_LD_REF_L1,0,0,0,0,0,0,0}}, /*Level 1 D cache read */
  {PAPI_FMA_INS,0,{PNE_PM_FPU_FMA,0,0,0,0,0,0,0}}, /*FMA instructions completed*/
  ...
  {PAPI_INT_INS,0,{PNE_PM_FXU_FIN,0,0,0,0,0,0,0}}, /*Integer instructions executed*/
  {PAPI_FP_INS,0,{PNE_PM_FPU_FIN,0,0,0,0,0,0,0}}, /*Floating point instructions executed*/	
/*  {PAPI_FP_INS,DERIVED_ADD,{"PM_FPU0_ALL","PM_FPU1_ALL","PM_FPU0_FIN",
  ...
  {PAPI_FLOPS,DERIVED_PS,{PNE_PM_CYC,PNE_PM_FPU_FIN,0,0,0,0,0,0}}, /*Floating Point instructions per second*/ 
 /* {PAPI_FLOPS,DERIVED_ADD_PS,{"PM_CYC","PM_FPU0_ALL","PM_FPU1_ALL","PM_FPU0_FIN",
  ...
  {PAPI_HW_INT,0,{PNE_PM_EXT_INT,0,0,0,0,0,0,0}}, /*Hardware interrupts*/
