...
/* Start editing here */
   ...
   {PAPI_L2_DCR,{DERIVED_ADD,{PNE_PM_DATA_FROM_L2, PNE_PM_DATA_FROM_L25_MOD,PNE_PM_DATA_FROM_L25_SHR,PNE_PM_DATA_FROM_L275_MOD,PNE_PM_DATA_FROM_L275_SHR,PAPI_NULL,PAPI_NULL,PAPI_NULL},0}},
   {PAPI_L2_DCM,{DERIVED_ADD,{PNE_PM_DATA_FROM_L3, PNE_PM_DATA_FROM_L35, PNE_PM_DATA_FROM_MEM, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL},0}}, /* Level 2 cache misses */
   {PAPI_L3_DCR,{DERIVED_ADD,{PNE_PM_DATA_FROM_L3, PNE_PM_DATA_FROM_L35, PNE_PM_DATA_FROM_MEM, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL},0}}, /* Level 2 cache misses */
   {PAPI_L3_DCM,{DERIVED_ADD,{PNE_PM_DATA_FROM_MEM, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL},0}}, /* Level 3 cache misses */
   {PAPI_L1_ICH,{0, {PNE_PM_INST_FROM_L1, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL},0}},
   {PAPI_L2_ICH,{0, {PNE_PM_INST_FROM_L2, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL},0}},
   {PAPI_L3_ICH,{0, {PNE_PM_INST_FROM_L3, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL, PAPI_NULL},0}},
/* Stop editing here */
