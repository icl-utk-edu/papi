...
static const pme_power_entry_t power10_pe[] = {
	...
	{.pme_name = "PM_BR_TKN_FIN",
	 ...
	 .pme_short_desc = "frontend; A taken branch (conditional or unconditional) finished",
	 .pme_long_desc = "frontend;A taken branch (conditional or unconditional) finished",
	},
	...
	.pme_short_desc = "Data Source;The processor's L1 data cache was reloaded from a source beyond the local core's L1 due to a demand miss.",
	.pme_long_desc = "Data Source;The processor's L1 data cache was reloaded from a source beyond the local core's L1 due to a demand miss.",
	},
	...
	.pme_short_desc = "Data Source;Store data line hit in the local L2. Includes cache-line states Sx, Tx, Mx.",
	.pme_long_desc = "Data Source;Store data line hit in the local L2. Includes cache-line states Sx, Tx, Mx.Since the event happens in a 2:1 clock domain and is time-sliced across all 4 threads, the event count should be multiplied by 2.",
	},
	...
	.pme_short_desc = "Data Source;Store data line hit in the local L3. Includes cache-line states Tx and Mx.",
	.pme_long_desc = "Data Source;Store data line hit in the local L3. Includes cache-line states Tx and Mx. If the cache line is in the Sx state, the RC machine will send a RWITM command. Since the event happens in a 2:1 clock domain and is time-sliced across all 4 threads, the event count should be multiplied by 2.",
	},
	...
	.pme_long_desc = "NA;An instruction fetch hit in the L1. Each fetch group contains 8 instructions. The same line can hit 4 times if 32 sequential instructions are fetched.",
	},
	{.pme_name = "PM_INST_FROM_L1MISS",
	.pme_code = 0x003F00000001C040,
	.pme_short_desc = "NA;The processor's instruction cache was reloaded from a source beyond the local core's L1 due to a demand miss.",
	.pme_long_desc = "NA;The processor's instruction cache was reloaded from a source beyond the local core's L1 due to a demand miss.",
	},
	...
	.pme_short_desc = "NA;All successful instruction (demand and prefetch) dispatches for this thread that missed in the L2.",
	.pme_long_desc = "NA;All successful instruction (demand and prefetch) dispatches for this thread that missed in the L2. Since the event happens in a 2:1 clock domain and is time-sliced across all 4 threads, the event count should be multiplied by 2.",
	},
	...
	.pme_short_desc = "NA;All successful D-side store dispatches for this thread that were L2 hits",
	.pme_long_desc = "NA;All successful D-side store dispatches for this thread that were L2 hits. Since the event happens in a 2:1 clock domain and is time-sliced across all 4 threads, the event count should be multiplied by 2.",
	},
	{.pme_name = "PM_L2_ST",
	...
	{.pme_name = "PM_PRED_BR_TKN_COND_DIR",
	 ...
	 .pme_short_desc = "frontend;A conditional branch finished with correctly predicted direction.",
	 .pme_long_desc = "frontend;A conditional branch finished with correctly predicted direction. Resolved taken",
	},
	{.pme_name = "PM_PRED_BR_NTKN_COND_DIR",
	.pme_code = 0x00000048B8,
	.pme_short_desc = "frontend;A conditional branch finished with correctly predicted direction.",
	.pme_long_desc = "frontend;A conditional branch finished with correctly predicted direction. Resolved not taken",
	},
