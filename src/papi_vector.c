...
int _papi_hwi_innoculate_vector(papi_vector_t *v){
 ...
 if(!v->ntv_enum_events) v->ntv_enum_events=		(int (*) (long long *, int)) vec_int_dummy;
 if(!v->ntv_name_to_code) v->ntv_name_to_code=		(int (*) (char *, long long *)) vec_int_dummy;
 if(!v->ntv_code_to_name) v->ntv_code_to_name=		(int (*) (long long, char *, int)) vec_int_dummy;
 if(!v->ntv_code_to_descr) v->ntv_code_to_descr=	(int (*) (long long, char *, int)) vec_int_ok_dummy;
 if(!v->ntv_code_to_bits) v->ntv_code_to_bits=		(int (*) (long long, hwd_register_t *)) vec_int_dummy;
 if(!v->ntv_bits_to_info) v->ntv_bits_to_info=		(int (*) (hwd_register_t *, char *, long long *, int, int)) vec_int_dummy;
