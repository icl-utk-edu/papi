...
hwi_search_t _papi_hwd_p2_preset_map[] = {
	{PAPI_L1_DCM,
	 {0, {PNE_P2_DCU_LINES_IN, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_ICM,
	 {0, {PNE_P2_L2_IFETCH_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_DCM,
	 {DERIVED_SUB,
	  {PNE_P2_L2_LINES_IN, PNE_P2_BUS_TRAN_IFETCH_SELF, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_ICM,
	 {0, {PNE_P2_BUS_TRAN_IFETCH_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_TCM,
	 {0, {PNE_P2_L2_RQSTS_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_TCM,
	 {0, {PNE_P2_L2_LINES_IN, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_CA_SHR,
	 {0, {PNE_P2_L2_RQSTS_S, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_CA_CLN,
	 {0, {PNE_P2_BUS_TRAN_RFO_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
/*   { PAPI_CA_INV,        {0, { PNE_P2_BUS_HITM_DRV,PAPI_NULL,PAPI_NULL,PAPI_NULL},{0,}}},   */
	{PAPI_CA_ITV,
	 {0, {PNE_P2_BUS_TRAN_INVAL_SELF, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TLB_IM,
	 {0, {PNE_P2_ITLB_MISS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_LDM,
	 {0, {PNE_P2_L2_LD_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_STM,
	 {0, {PNE_P2_L2_ST_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_LDM,
	 {DERIVED_SUB,
	  {PNE_P2_L2_LINES_IN, PNE_P2_L2_M_LINES_INM, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_STM,
	 {0, {PNE_P2_L2_M_LINES_INM, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BTAC_M,
	 {0, {PNE_P2_BTB_MISSES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_HW_INT,
	 {0, {PNE_P2_HW_INT_RX, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_CN,
	 {0, {PNE_P2_BR_INST_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_TKN,
	 {0, {PNE_P2_BR_TAKEN_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_NTK,
	 {DERIVED_SUB,
	  {PNE_P2_BR_INST_RETIRED, PNE_P2_BR_TAKEN_RETIRED, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_BR_MSP,
	 {0, {PNE_P2_BR_MISS_PRED_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_PRC,
	 {DERIVED_SUB,
	  {PNE_P2_BR_INST_RETIRED, PNE_P2_BR_MISS_PRED_RETIRED, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_TOT_IIS,
	 {0, {PNE_P2_INST_DECODED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TOT_INS,
	 {0, {PNE_P2_INST_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_FP_INS, {0, {PNE_P2_FLOPS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_FP_OPS, {0, {PNE_P2_FLOPS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_INS,
	 {0, {PNE_P2_BR_INST_RETIRED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_VEC_INS,
	 {0, {PNE_P2_MMX_INSTR_EXEC, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_RES_STL,
	 {0, {PNE_P2_RESOURCE_STALLS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TOT_CYC,
	 {0, {PNE_P2_CPU_CLK_UNHALTED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_DCH,
	 {DERIVED_SUB,
	  {PNE_P2_DATA_MEM_REFS, PNE_P2_DCU_LINES_IN, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_DCA,
	 {0, {PNE_P2_DATA_MEM_REFS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_DCA,
	 {DERIVED_ADD, {PNE_P2_L2_LD_MESI, PNE_P2_L2_ST_MESI, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_DCR,
	 {0, {PNE_P2_L2_LD_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_DCW,
	...
	{PAPI_L1_ICH,
	 {DERIVED_SUB,
	  {PNE_P2_IFU_IFETCH, PNE_P2_L2_IFETCH_MESI, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_ICH,
	 {DERIVED_SUB,
	  {PNE_P2_L2_IFETCH_MESI, PNE_P2_BUS_TRAN_IFETCH_SELF, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L1_ICA,
	 {0, {PNE_P2_IFU_IFETCH, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_ICA,
	 {0, {PNE_P2_L2_IFETCH_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_ICR,
	 {0, {PNE_P2_IFU_IFETCH, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	...
	{PAPI_L2_TCH,
	 {DERIVED_SUB,
	  {PNE_P2_L2_RQSTS_MESI, PNE_P2_L2_LINES_IN, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_TCA,
	 {DERIVED_ADD,
	  {PNE_P2_DATA_MEM_REFS, PNE_P2_IFU_IFETCH, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_TCA,
	 {0, {PNE_P2_L2_RQSTS_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_TCR,
	 {DERIVED_ADD,
	  {PNE_P2_L2_LD_MESI, PNE_P2_L2_IFETCH_MESI, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_TCW,
	 {0, {PNE_P2_L2_ST_MESI, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
...
const int _papi_hwd_p2_native_count =
	( PNE_P2_LAST_NATIVE_EVENT & PAPI_NATIVE_AND_MASK );
