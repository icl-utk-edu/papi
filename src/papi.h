...
enum {
   ...
   PAPI_ENUM_FIRST_COMP,		/**< Enumerate first component preset event */
...
enum {
   ...
   typedef struct event_info {
     ...
     int  compIdx;                                         /**< component ID */
     int  num_quals;                                       /**< number of qualifiers */
     char quals[PAPI_MAX_COMP_QUALS][PAPI_HUGE_STR_LEN];   /**< qualifiers */
     char descrs[PAPI_MAX_COMP_QUALS][PAPI_HUGE_STR_LEN];  /**< qualifier descriptions */
   } PAPI_event_info_t;
