...
/* Sysdetect component defines */
        ...
        {PAPI_DEV_ATTR__CPU_UINT_NUMA_THR_LIST, "PAPI_DEV_ATTR__CPU_UINT_NUMA_THR_LIST", NULL},
        ...
        {PAPI_DEV_ATTR__CUDA_UINT_CPU_THR_AFFINITY_LIST, "PAPI_DEV_ATTR__CUDA_UINT_CPU_THR_AFFINITY_LIST", NULL},
        {PAPI_DEV_ATTR__CUDA_UINT_CPU_THR_PER_DEVICE, "PAPI_DEV_ATTR__CUDA_UINT_CPU_THR_PER_DEVICE", NULL},
