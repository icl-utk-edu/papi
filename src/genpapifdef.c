...
int main(int argc, char **argv) 
{
  ...
  printf("!\tIt is automagically generated by genpapifdef.c\n");
  printf("!\tDO NOT modify its contents and expect the changes to stick.\n");
  printf("!\tChanges MUST be made in genpapifdef.c instead.\n!\n\n");
