...
const hwi_search_t _papi_hwd_opt_preset_map[] = {
	{PAPI_L1_ICH,
	 {DERIVED_POSTFIX,
	  {PNE_OPT_IC_FETCH, PNE_OPT_IC_SYS_REFILL, PNE_OPT_IC_L2_REFILL,
	   PAPI_NULL}, {"N0|N1|-|N2|-|",}}},
	{PAPI_L2_ICH,
	 {0, {PNE_OPT_IC_L2_REFILL, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_DCM,
	 {DERIVED_ADD,
	  {PNE_OPT_DC_SYS_REFILL_MOES, PNE_OPT_DC_L2_REFILL_MOES, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_L1_ICM,
	 {DERIVED_ADD,
	  {PNE_OPT_IC_L2_REFILL, PNE_OPT_IC_SYS_REFILL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_DCM,
	 {0, {PNE_OPT_DC_SYS_REFILL_MOES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_ICM,
	 {0, {PNE_OPT_IC_SYS_REFILL, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_TCM,
	 {DERIVED_ADD,
	  {PNE_OPT_DC_SYS_REFILL_MOES, PNE_OPT_IC_SYS_REFILL, PNE_OPT_IC_L2_REFILL,
	   PNE_OPT_DC_L2_REFILL_MOES, PAPI_NULL}, {0,}}},
	{PAPI_L2_TCM,
	 {DERIVED_ADD,
	  {PNE_OPT_DC_SYS_REFILL_MOES, PNE_OPT_IC_SYS_REFILL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_FPU_IDL,
	 {0, {PNE_OPT_FP_NONE_RET, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TLB_DM,
	 {0,
	  {PNE_OPT_DC_L1_DTLB_MISS_AND_L2_DTLB_MISS, PAPI_NULL, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{PAPI_TLB_IM,
	 {0,
	  {PNE_OPT_IC_L1ITLB_MISS_AND_L2ITLB_MISS, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_TLB_TL,
	 {DERIVED_ADD,
	  {PNE_OPT_DC_L1_DTLB_MISS_AND_L2_DTLB_MISS,
	   PNE_OPT_IC_L1ITLB_MISS_AND_L2ITLB_MISS, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_LDM,
	 {0, {PNE_OPT_DC_L2_REFILL_OES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_STM,
	 {0, {PNE_OPT_DC_L2_REFILL_M, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_LDM,
	 {0, {PNE_OPT_DC_SYS_REFILL_OES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_STM,
	 {0, {PNE_OPT_DC_SYS_REFILL_M, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_STL_ICY,
	 {0, {PNE_OPT_EU_DECODER_EMPTY, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_HW_INT,
	 {0, {PNE_OPT_EU_HW_INTS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_TKN,
	 {0, {PNE_OPT_EU_BR_TAKEN, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_BR_MSP,
	 {0, {PNE_OPT_EU_BR_MIS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TOT_INS,
	 {0, {PNE_OPT_EU_RET_X86_INS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
...
*/
	{PAPI_FP_INS,
	 {0,
	  {PNE_OPT_EU_FPU_X87_SSE_SSE2_SCALAR_PACKED, PAPI_NULL, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
...
*/
	{PAPI_FP_OPS,
	 {0, {PNE_OPT_FP_MULT_AND_ADD_PIPE, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
...
*/
	...
	{PAPI_VEC_INS,
	 {0, {PNE_OPT_EU_FPU_SSE_SSE2_PACKED, PAPI_NULL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_RES_STL,
	 {0, {PNE_OPT_EU_DISP_STALLS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_TOT_CYC,
	 {0, {PNE_OPT_EU_CPU_CLK_UNHALTED, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_DCH,
	 {DERIVED_POSTFIX,
	  {PNE_OPT_DC_ACCESS, PNE_OPT_DC_L2_REFILL_MOES, PNE_OPT_DC_SYS_REFILL_MOES,
	   PAPI_NULL}, {"N0|N1|-|N2|-|",}}},
	{PAPI_L2_DCH,
	 {0, {PNE_OPT_DC_L2_REFILL_MOES, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_DCA,
	 {0, {PNE_OPT_DC_ACCESS, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_DCA,
	 {DERIVED_ADD,
	  {PNE_OPT_DC_SYS_REFILL_MOES, PNE_OPT_DC_L2_REFILL_MOES, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	...
	{PAPI_L2_DCW,
	 {0, {PNE_OPT_DC_L2_REFILL_M, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_ICA,
	 {0, {PNE_OPT_IC_FETCH, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L2_ICA,
	 {DERIVED_ADD,
	  {PNE_OPT_IC_L2_REFILL, PNE_OPT_IC_SYS_REFILL, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L1_ICR,
	 {0, {PNE_OPT_IC_FETCH, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_TCA,
	 {DERIVED_ADD, {PNE_OPT_DC_ACCESS, PNE_OPT_IC_FETCH, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_L2_TCA,
	 {DERIVED_ADD,
	  {PNE_OPT_IC_L2_REFILL, PNE_OPT_IC_SYS_REFILL, PNE_OPT_DC_L2_REFILL_MOES,
	   PNE_OPT_DC_SYS_REFILL_MOES, PAPI_NULL}, {0,}}},
	{PAPI_L2_TCH,
	 {DERIVED_ADD,
	  {PNE_OPT_IC_L2_REFILL, PNE_OPT_DC_L2_REFILL_MOES, PAPI_NULL, PAPI_NULL},
	  {0,}}},
	{PAPI_FML_INS,
	 {0, {PNE_OPT_FP_MULT_PIPE, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_FAD_INS,
	 {0, {PNE_OPT_FP_ADD_PIPE, PAPI_NULL, PAPI_NULL, PAPI_NULL}, {0,}}},
	{PAPI_L1_TCH,
	 {DERIVED_POSTFIX,
	  {PNE_OPT_DC_ACCESS, PNE_OPT_IC_FETCH, PNE_OPT_DC_MISS, PNE_OPT_IC_MISS,
	   PAPI_NULL}, {"N0|N1|+|N2|-|N3|-|"}}},
...
hwi_search_t _papi_hwd_opt_FP_SSE_SP[] = {
	{PAPI_FP_OPS,
	 {DERIVED_SUB,
	  {PNE_OPT_EU_FPU_X87_SSE_SSE2_SCALAR_PACKED, PNE_OPT_FP_ST_PIPE, PAPI_NULL,
	   PAPI_NULL}, {0,}}},
	{0, {0, {0,}, {0,}}}
};
...
hwi_search_t _papi_hwd_opt_FP_SSE_DP[] = {
	{PAPI_FP_OPS,
	 {DERIVED_SUB,
	  {PNE_OPT_EU_FPU_X87_SSE_SSE2_SCALAR_PACKED, PNE_OPT_FP_ST_PIPE_AND_LOAD,
...
/* preset, note */
	{PAPI_FP_OPS,
	 "Counts all retired floating point operations, including data movement. Precise, and proportional to work done, but much higher than theoretical."},
	{0, NULL}
};
...
/* preset, note */
	{PAPI_FP_OPS,
	 "Counts speculative adds and multiplies. Variable and higher than theoretical."},
	{0, NULL}
};
...
/* preset, note */
	{PAPI_FP_OPS,
	 "Counts retired ops corrected for data motion. Optimized for single precision; lower than theoretical."},
	{0, NULL}
};
...
/* preset, note */
	{PAPI_FP_OPS,
	 "Counts retired ops corrected for data motion. Optimized for double precision; lower than theoretical."},
	{0, NULL}
};
...
const int _papi_hwd_k8_native_count =
	( PNE_OPT_LAST_NATIVE_EVENT & PAPI_NATIVE_AND_MASK );
...
void
_papi_hwd_fixup_fp( hwi_search_t ** s, const hwi_dev_notes_t ** n )
{
	...
	if ( strstr( str, "RETIRED" ) )
		mask = FP_RETIRED;
	if ( strstr( str, "SPECULATIVE" ) )
		mask = FP_SPECULATIVE;
