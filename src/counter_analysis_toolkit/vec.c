...
void vec_driver(char* papi_event_name, hw_desc_t *hw_desc, char* outdir)
{
    ...
    test_hp_scalar_VEC_24( EventSet, ofp_papi );
    test_hp_scalar_VEC_48( EventSet, ofp_papi );
    test_hp_scalar_VEC_96( EventSet, ofp_papi );

    fprintf(ofp_papi, "# HP Non-FMA Vector AVX128\n");
    test_hp_x86_128B_VEC( 24, EventSet, ofp_papi );
    test_hp_x86_128B_VEC( 48, EventSet, ofp_papi );
    test_hp_x86_128B_VEC( 96, EventSet, ofp_papi );

  #if defined(AVX256_AVAIL)
    fprintf(ofp_papi, "# HP Non-FMA Vector AVX256\n");
    test_hp_x86_256B_VEC( 24, EventSet, ofp_papi );
    test_hp_x86_256B_VEC( 48, EventSet, ofp_papi );
    test_hp_x86_256B_VEC( 96, EventSet, ofp_papi );

    #if defined(AVX512_AVAIL)
    fprintf(ofp_papi, "# HP Non-FMA Vector AVX512\n");
    test_hp_x86_512B_VEC( 24, EventSet, ofp_papi );
    test_hp_x86_512B_VEC( 48, EventSet, ofp_papi );
    test_hp_x86_512B_VEC( 96, EventSet, ofp_papi );
    #endif
  #endif
    ...
    test_hp_scalar_VEC_FMA_12( EventSet, ofp_papi );
    test_hp_scalar_VEC_FMA_24( EventSet, ofp_papi );
    test_hp_scalar_VEC_FMA_48( EventSet, ofp_papi );

    fprintf(ofp_papi, "# HP FMA Vector AVX128\n");
    test_hp_x86_128B_VEC_FMA( 12, EventSet, ofp_papi );
    test_hp_x86_128B_VEC_FMA( 24, EventSet, ofp_papi );
    test_hp_x86_128B_VEC_FMA( 48, EventSet, ofp_papi );

  #if defined(AVX256_AVAIL)
    fprintf(ofp_papi, "# HP FMA Vector AVX256\n");
    test_hp_x86_256B_VEC_FMA( 12, EventSet, ofp_papi );
    test_hp_x86_256B_VEC_FMA( 24, EventSet, ofp_papi );
    test_hp_x86_256B_VEC_FMA( 48, EventSet, ofp_papi );

    #if defined(AVX512_AVAIL)
    fprintf(ofp_papi, "# HP FMA Vector AVX512\n");
    test_hp_x86_512B_VEC_FMA( 12, EventSet, ofp_papi );
    test_hp_x86_512B_VEC_FMA( 24, EventSet, ofp_papi );
    test_hp_x86_512B_VEC_FMA( 48, EventSet, ofp_papi );
    #endif
  #endif
    ...
    test_hp_arm_VEC( 24, EventSet, ofp_papi );
    test_hp_arm_VEC( 48, EventSet, ofp_papi );
    test_hp_arm_VEC( 96, EventSet, ofp_papi );
    ...
    test_hp_arm_VEC_FMA( 12, EventSet, ofp_papi );
    test_hp_arm_VEC_FMA( 24, EventSet, ofp_papi );
    test_hp_arm_VEC_FMA( 48, EventSet, ofp_papi );
    ...
    fprintf(ofp_papi, "# HP Non-FMA Vector\n");
    test_hp_power_VEC( 24, EventSet, ofp_papi );
    test_hp_power_VEC( 48, EventSet, ofp_papi );
    test_hp_power_VEC( 96, EventSet, ofp_papi );
    ...
    fprintf(ofp_papi, "# HP FMA Vector\n");
    test_hp_power_VEC_FMA( 12, EventSet, ofp_papi );
    test_hp_power_VEC_FMA( 24, EventSet, ofp_papi );
    test_hp_power_VEC_FMA( 48, EventSet, ofp_papi );
