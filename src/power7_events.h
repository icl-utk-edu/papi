...
*
* This is straight from power6_events.h, with group_ints changed
* to support the higher number of max groups on power7.
* 
* The native_name enum is unchanged, and needs to be??
*/
