...
const P4_search_t _papi_hwd_pentium4_preset_map[] = {
  ...
  /*{ PAPI_L1_LDM, NULL, 1<<0xC, 1<<0xC, 1,
    {{{COUNTER(0xC) | FAST_RDPMC, HYPERTHREAD_ANY | ESCR(5) | ENABLE, EVENT(9) | EVENTMASK(0x1) | CPL(1), PEBS_TAG | PEBS_L1_MISS, PEBS_MV_LOAD} }}}, -REMOVED*/
  /*{ PAPI_L1_STM, NULL, 1<<0xC, 1<<0xC, 1,
    {{{COUNTER(0xC) | FAST_RDPMC, HYPERTHREAD_ANY | ESCR(5) | ENABLE, EVENT(9) | EVENTMASK(0x1) | CPL(1), PEBS_TAG | PEBS_L1_MISS, PEBS_MV_STORE} }}}, -REMOVED*/
  ...
  /*{ PAPI_L2_LDM, NULL, 1<<0xC, 1<<0xC, 1,
    {{{COUNTER(0xC) | FAST_RDPMC, HYPERTHREAD_ANY | ESCR(5) | ENABLE, EVENT(9) | EVENTMASK(0x1) | CPL(1), PEBS_TAG | PEBS_L2_MISS, PEBS_MV_LOAD} }}}, REMOVED*/
  /*{ PAPI_L2_STM, NULL, 1<<0xC, 1<<0xC, 1,
    {{{COUNTER(0xC) | FAST_RDPMC, HYPERTHREAD_ANY | ESCR(5) | ENABLE, EVENT(9) | EVENTMASK(0x1) | CPL(1), PEBS_TAG | PEBS_L2_MISS, PEBS_MV_STORE} }}}, REMOVED*/
  /*{ PAPI_L2_DCM, NULL, 1<<0xC, 1<<0xC, 1,
    {{{COUNTER(0xC) | FAST_RDPMC, HYPERTHREAD_ANY | ESCR(5) | ENABLE, EVENT(9) | EVENTMASK(0x1) | CPL(1), PEBS_TAG | PEBS_L2_MISS, PEBS_MV_STORE | PEBS_MV_LOAD} }}}, REMOVED */
  { 0, NULL, }
};
