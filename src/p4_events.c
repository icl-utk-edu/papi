...
/* preset, derived, native index array */
   {PAPI_RES_STL, {0, {PNE_replay_event, 0,}, {0,}}},
   {PAPI_BR_INS, {0, {PNE_branch_retired_all, 0,}, {0,}}},
   {PAPI_BR_TKN, {0, {PNE_branch_retired_taken, 0,}, {0,}}},
   {PAPI_BR_NTK, {0, {PNE_branch_retired_not_taken, 0,}, {0,}}},
   {PAPI_BR_MSP, {0, {PNE_branch_retired_mispredicted, 0,}, {0,}}},
   {PAPI_BR_PRC, {0, {PNE_branch_retired_predicted, 0,}, {0,}}},
   {PAPI_TLB_DM, {0, {PNE_page_walk_type_data_miss, 0,}, {0,}}},
   {PAPI_TLB_IM, {0, {PNE_page_walk_type_instr_miss, 0,}, {0,}}},
   {PAPI_TLB_TL, {0, {PNE_page_walk_type_all, 0,}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_instr_retired_non_bogus, 0,}, {0,}}},
   {PAPI_FP_INS, {0, {PNE_execution_event_nbogus0, PNE_x87_FP_uop_tag0, 0,}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_cycles, 0,}, {0,}}},
   {PAPI_L1_LDM, {0, {PNE_replay_event_L1_load_miss, 0,}, {0,}}},
//  {PAPI_L1_STM,  {0, { PNE_replay_event_L1_store_miss,0,},{0,}}},
   {PAPI_L1_DCM, {0, {PNE_replay_event_L1_data_miss, 0,}, {0,}}},
   {PAPI_L2_LDM, {0, {PNE_replay_event_L2_load_miss, 0,}, {0,}}},
//  {PAPI_L2_STM,  {0, { PNE_replay_event_L2_store_miss,0,},{0,}}},
   {PAPI_L2_DCM, {0, {PNE_replay_event_L2_data_miss, 0,}, {0,}}},
   {0, {0, {0,}, {0,}}}
};
...
/* preset, derived, native index array */
   ...
   {PAPI_TLB_TL, {0, {PNE_page_walk_type_all, 0,}, {0,}}},
   {PAPI_TOT_INS, {0, {PNE_instr_retired_non_bogus, 0,}, {0,}}},
   {PAPI_TOT_IIS, {0, {PNE_instr_retired_all, 0,}, {0,}}},
   {PAPI_FP_INS, {0, {PNE_execution_event_nbogus0, PNE_x87_FP_uop_tag0, 0,}, {0,}}},
   {PAPI_TOT_CYC, {0, {PNE_cycles, 0,}, {0,}}},
   {PAPI_L1_LDM, {0, {PNE_replay_event_L1_load_miss, 0,}, {0,}}},
//  {PAPI_L1_STM,  {0, { PNE_replay_event_L1_store_miss,0,},{0,}}},
   {PAPI_L1_DCM, {0, {PNE_replay_event_L1_data_miss, 0,}, {0,}}},
   {PAPI_L1_DCA, {0, {PNE_replay_event_L1_data_access, 0,}, {0,}}},
   {PAPI_L2_LDM, {0, {PNE_replay_event_L2_load_miss, 0,}, {0,}}},
//  {PAPI_L2_STM,  {0, { PNE_replay_event_L2_store_miss,0,},{0,}}},
   {PAPI_L2_DCM, {0, {PNE_replay_event_L2_data_miss, 0,}, {0,}}},
   {0, {0, {0,}, {0,}}}
...
// following are the non-retirement events
   {
    ...
    "This event counts the duration (in clock cycles) of the operating modes of the trace cache and decode engine in the processor package. The mode is specified by one or more of the event mask bits.",
    {
     ...
     0, 0, 0},
    (1 << DD) | (1 << DB) | (1 << DI) | (1 << BD) | (1 << BB) | (1 << BI) | (1 << ID) | (1
                                                                                         <<
                                                                                         IB),
    0},
   {
    ...
    0},
   {
    ...
    | (1 << RD_3rdL_HITE) | (1 << RD_3rdL_HITM) | (1 << RD_2ndL_MISS) | (1 <<
                                                                         RD_3rdL_MISS) |
    (1 << WR_2ndL_MISS),
    0},
   {
    ...
    (1 << BUS_RQ_TYP4) | (1 << ALL_READ) | (1 << ALL_WRITE) | (1 << MEM_UC) | (1 <<
                                                                               MEM_WC) |
    (1 << MEM_WT) | (1 << MEM_WP) | (1 << MEM_WB) | (1 << OWN) | (1 << OTHER) | (1 <<
                                                                                 PREFETCH),
    0},
   {
    "IOQ_active_entries",
    ...
    0},
   {
    ...
    "This event increments once for each DRDY or DBSY event that occurs on the front side bus. The event allows selection of a specific DRDY or DBSY event.",
    {
     ...
     0, 0, 0},
    (1 << DRDY_DRV) | (1 << DRDY_OWN) | (1 << DRDY_OTHER) | (1 << DBSY_DRV) | (1 <<
                                                                               DBSY_OWN) |
    (1 << DBSY_OTHER),
    0},
   {
    ...
    "This event counts allocations in the Bus Sequence Unit (BSQ) according to the specified mask bit encoding.",
    {
     ...
     0, 0, 0},
    (1 << REQ_TYPE0) | (1 << REQ_TYPE1) | (1 << REQ_LEN0) | (1 << REQ_LEN1) | (1 <<
                                                                               REQ_IO_TYPE)
    | (1 << REQ_LOCK_TYPE) | (1 << REQ_CACHE_TYPE) | (1 << REQ_SPLIT_TYPE) | (1 <<
                                                                              REQ_DEM_TYPE)
...
static char *internal_translate_code(int event, int mask, char *str, char *separator)
{
   ...
   if (!mask)
      return (str);
   if ((_papi_hwd_pentium4_native_map[event].mask & mask) != mask)
      return (NULL);
                         ...
                         hwd_register_t * bits)
{
   ...
   if (_papi_hwd_pentium4_user_count >=
