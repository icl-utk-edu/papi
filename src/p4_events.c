...
const P4_search_t _papi_hwd_pentium4_mlt2_preset_map[] = {
  ...
  { PAPI_VEC_INS,  NULL, 3,
    {{{ COUNTER(12) | COUNTER(13) | COUNTER(16), 
	HYPERTHREAD_ANY | ESCR(5) | ENABLE, 
	EVENT(0xC) | (1 << 10) | CPL(1) }, 
      { COUNTER(10) | COUNTER(11), 
	HYPERTHREAD_ANY | ESCR(1) | ENABLE, 
	EVENT(0x2) | (1 << 24) | (1 << 6) | (1 << 4) | CPL(1)} }}},
      { COUNTER(10) | COUNTER(11), 
	HYPERTHREAD_ANY | ESCR(1) | ENABLE, 
	EVENT(0x1A) | (1 << 24) | (1 << 6) | (1 << 4) | CPL(1)} }}},
/*
  { PAPI_TOT_CYC, NULL, 1,
    {{{ COUNTER(4), 
	...
	CPL(1)} }}},
*/
/* I think this'll work... should be global power events */
  { PAPI_TOT_CYC, NULL, 1,
   {{{ COUNTER(2) | COUNTER(3), 
       HYPERTHREAD_ANY | ESCR(6) | ENABLE, 
       EVENT(0x13) | ESCR_EVENT_MASK(0x1) | CPL(1)} }}},
  { PAPI_L1_LDM, NULL, 1,
    {{{ COUNTER(12) | COUNTER(13) | COUNTER(16), 
	HYPERTHREAD_ANY | ESCR(5) | ENABLE, 
