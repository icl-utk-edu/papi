...
const hwi_preset_info_t _papi_hwi_preset_info[PAPI_MAX_PRESET_EVENTS] = {
   ...
   /* 56*/ {"PAPI_VEC_INS", "Vector/SIMD instr", "Vector/SIMD instructions (could include integer)"},
   ...
   /*103*/ {"PAPI_SP_OPS",  "SP operations", "Floating point operations; optimized to count scaled single precision vector operations"},
   /*104*/ {"PAPI_DP_OPS",  "DP operations", "Floating point operations; optimized to count scaled double precision vector operations"},
...
const unsigned int _papi_hwi_preset_type[] = {
   ...
   /*  1: PAPI_L1_ICM */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L1 + PAPI_PRESET_BIT_INS,
   /*  2: PAPI_L2_DCM */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L2,
   /*  3: PAPI_L2_ICM */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L2 + PAPI_PRESET_BIT_INS,
   /*  4: PAPI_L3_DCM */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L3,
   /*  5: PAPI_L3_ICM */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L3 + PAPI_PRESET_BIT_INS,
   ...
   /* 73: PAPI_L1_ICH */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L1 + PAPI_PRESET_BIT_INS,
   /* 74: PAPI_L2_ICH */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L2 + PAPI_PRESET_BIT_INS,
   /* 75: PAPI_L3_ICH */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L3 + PAPI_PRESET_BIT_INS,
   /* 76: PAPI_L1_ICA */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L1 + PAPI_PRESET_BIT_INS,
   /* 77: PAPI_L2_ICA */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L2 + PAPI_PRESET_BIT_INS,
   /* 78: PAPI_L3_ICA */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L3 + PAPI_PRESET_BIT_INS,
   /* 79: PAPI_L1_ICR */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L1 + PAPI_PRESET_BIT_INS,
   /* 80: PAPI_L2_ICR */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L2 + PAPI_PRESET_BIT_INS,
   /* 81: PAPI_L3_ICR */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L3 + PAPI_PRESET_BIT_INS,
   /* 82: PAPI_L1_ICW */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L1 + PAPI_PRESET_BIT_INS,
   /* 83: PAPI_L2_ICW */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L2 + PAPI_PRESET_BIT_INS,
   /* 84: PAPI_L3_ICW */  PAPI_PRESET_BIT_CACH + PAPI_PRESET_BIT_L3 + PAPI_PRESET_BIT_INS,
