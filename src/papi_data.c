...
const unsigned int _papi_hwi_preset_type[] = {
   ...
   /* empty entries are now null pointers instead of pointers to empty strings */
#ifdef _BGL
   /*103: PAPI_BGL_OED */  PAPI_PRESET_BIT_MSC,
   /*104: PAPI_BGL_TS_32B */  PAPI_PRESET_BIT_MSC,
   /*105: PAPI_BGL_TS_FULL */  PAPI_PRESET_BIT_MSC, 
   /*106: PAPI_BGL_TR_DPKT */  PAPI_PRESET_BIT_MSC,
   /*107: PAPI_BGL_TR_FULL */  PAPI_PRESET_BIT_MSC,
#else
   /*103*/ 0,
   /*104*/ 0,
   /*105*/ 0,
...
const hwi_describe_t _papi_hwi_err[PAPI_NUM_ERRORS] = {
   ...
   /*18*/ {PAPI_ENOCMP, "PAPI_ENOCMP", "Component Index isn't set"}
};
