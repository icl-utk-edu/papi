...
/* List of exposed function pointers for this component */
	...
	int ( *update_control_state ) ( hwd_control_state_t *, NativeInfo_t *, int,
									hwd_context_t * );
	...
	int ( *add_prog_event ) ( hwd_control_state_t *, unsigned int, void *,
							  EventInfo_t * );
	...
	int ( *ntv_bits_to_info ) ( hwd_register_t *, char *, unsigned int *, int,
								int );
