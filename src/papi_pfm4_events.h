#ifndef _PAPI_PFM4_EVENTS_H
#define _PAPI_PFM4_EVENTS_H
/* 
* File:    papi_pfm4_events.h
* CVS:     $Id$
...
#define PAPI_EVENT_FILE "papi_pfm4_events.csv"
