...
/*
  { PAPI_FLOPS, { 0, VC_FP_INSTR_EXECUTED, VC_TOTAL_CYCLES },
  { PAPI_IPS, { 0, VC_TOTAL_INSTR_EXECUTED, VC_TOTAL_CYCLES },
  { PAPI_BR_INS, { 0, VC_UNCOND_BR_EXECUTED, VC_COND_BR_EXECUTED},
  { PAPI_TLB_TL, { 0, {VC_ITBMISS_TRAPS, VC_TOTAL_DTBMISS },
*/
