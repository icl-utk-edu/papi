...
extern int _p3_ntv_code_to_bits( unsigned int EventCode,
								 hwd_register_t * bits );
extern int _p3_ntv_bits_to_info( hwd_register_t * bits, char *names,
...
static int
_p3_init_control_state( hwd_control_state_t * ptr )
{
	int i, def_mode = 0;
...
int
_p3_set_domain( hwd_control_state_t * cntrl, int domain )
{
	int i, did = 0;
...
static int
_p3_bpt_map_avail( hwd_reg_alloc_t * dst, int ctr )
{
...
/* This function forces the event to
    ...
    Returns nothing.  */
static void
_p3_bpt_map_set( hwd_reg_alloc_t * dst, int ctr )
{
...
static int
_p3_bpt_map_exclusive( hwd_reg_alloc_t * dst )
{
...
static int
_p3_bpt_map_shared( hwd_reg_alloc_t * dst, hwd_reg_alloc_t * src )
{
...
/* This function removes shared resources available to the src event
    ...
    Returns nothing.  */
static void
_p3_bpt_map_preempt( hwd_reg_alloc_t * dst, hwd_reg_alloc_t * src )
{
	int i;
	unsigned shared;
...
static void
_p3_bpt_map_update( hwd_reg_alloc_t * dst, hwd_reg_alloc_t * src )
{
...
/* Register allocation */
static int
_p3_allocate_registers( EventSetInfo_t * ESI )
{
	int i, j, natNum;
	...
	for ( i = 0; i < natNum; i++ ) {
		...
		_p3_ntv_code_to_bits( ( unsigned int ) ESI->NativeInfoArray[i].ni_event,
		...
		if ( _papi_hwi_system_info.hw_info.model == PERFCTR_X86_INTEL_CORE2 )
			event_list[i].ra_selector |=
				( ( event_list[i].ra_bits.selector >> 16 ) << 2 ) & ALLCNTRS;
#endif
...
static int
_p3_update_control_state( hwd_control_state_t * this_state,
...
static int
_p3_start( hwd_context_t * ctx, hwd_control_state_t * state )
{
	int error;
#ifdef DEBUG
...
static int
_p3_stop( hwd_context_t * ctx, hwd_control_state_t * state )
{
	int error;
...
static int
_p3_read( hwd_context_t * ctx, hwd_control_state_t * spc, long long **dp,
		  int flags )
{
...
static int
_p3_reset( hwd_context_t * ctx, hwd_control_state_t * cntrl )
{
...
static int
_p3_set_overflow( EventSetInfo_t * ESI, int EventIndex, int threshold )
{
...
static int
_p3_stop_profiling( ThreadInfo_t * master, EventSetInfo_t * ESI )
{
	( void ) master;		 /*unused */
	( void ) ESI;			 /*unused */
	return ( PAPI_OK );
