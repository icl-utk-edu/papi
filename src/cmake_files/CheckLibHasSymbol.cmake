...
Provides a macro to check if a symbol exists as a function in a library.

.. command:: check_lib_has_symbol

  .. code-block:: cmake

    check_lib_has_symbol(<symbol> <libs> <variable>)

  Check that the ``<symbol>`` is available in given ``<lib>`` and store the result in a ``<variable>``.  Specify the list
...
macro(CHECK_LIB_HAS_SYMBOL SYMBOL FILES VARIABLE)
