...
main(int argc, char **argv)
{
    ...
    /*
     * The Problem: (perfmon) PAPI_stop() in the child kills the
     * parent's PAPI, unless we do a shutdown in the parent before the
     * fork and re-init after.  PAPI_shutdown() in the child doesn't
     * help.
     */
