...
int add_two_events(int *num_events, long long *papi_event, const PAPI_hw_info_t *hw_info, int *mask);
int add_two_nonderived_events(int *num_events, long long *papi_event, const PAPI_hw_info_t *hw_info, int *mask);
